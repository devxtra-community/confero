...
export default function VideoCall({
  ...
  // CRITICAL FIX: State to track if remote video is actually ready to show
  ...
  const createPeerConnection = useCallback(() => {
    ...
    pc.ontrack = event => {
      ...
      // Logic Fix: Ensure we capture the stream correctly
    ...
    <div className="min-h-screen w-full bg-gray-900 flex overflow-hidden">
      ...
      <main className="flex-1 flex flex-col relative">
        ...
        <section className="flex-1 relative bg-black">
          ...
          {/* Logic Fix: Using hasRemoteVideo state instead of ref for visibility */}
          {!hasRemoteVideo && (
