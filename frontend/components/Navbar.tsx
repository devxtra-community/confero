                ...
                <div className="flex items-center justify-between gap-6">
                    ...
                    <div className="flex items-center gap-3 font-sans">
                        <div className="hidden sm:flex items-center gap-3">
                            <Link href="/login"> <button className="px-5 py-2 text-sm cursor-pointer text-white bg-glass border border-white/20 rounded-full hover:bg-glassHover">
                                Login
                            </button>
                            </Link>
                            <Link href="/signup">                            <button className="px-5 py-2 text-sm text-white bg-buttonBg rounded-full cursor-pointer">
                                Sign Up
                            </button></Link>
                        </div>
          ...
          `}
                >
                    <div className="flex flex-col items-center gap-5 text-white text-md font-sans pb-4">
                        <Link href="/"><p onClick={() => setOpen(false)}>Home</p></Link>
                        <p onClick={() => setOpen(false)}>Features</p>
                        <p onClick={() => setOpen(false)}>FAQ</p>

                        <div className="w-full h-px bg-white/20" />

                        <Link href="/login" className="w-full py-2 bg-glass rounded-full text-center"> <button >
                            Login
                        </button></Link>
                        <Link href="/signup" className="w-full py-2 bg-buttonBg rounded-full text-center"><button>
                            Sign Up
                        </button>
                        </Link>
                    </div>
